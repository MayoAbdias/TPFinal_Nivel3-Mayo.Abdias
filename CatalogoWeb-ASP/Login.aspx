...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="bg-black card text-white text-center">¿Ya sos usuario?<strong>Logueate..</strong></h2>
    <div class="row justify-content-center mt-5 shadow-lg p-3 bg-transparent text-lg-center ">
        <div class="col-6">
            <div class="mb-3">
                <asp:Label Text="Email" CssClass="accordion-body border-top border-2 border-dark-subtle form-control-lg" runat="server" />
            ...
            <div class="mb-3">
                <asp:Label Text="Contraseña" CssClass="accordion-body border-2 border-dark-subtle border-top form-control-lg" runat="server" />
